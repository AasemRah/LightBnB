...
INSERT INTO users (id, name, email, password) VALUES
  (1, 'Eva Stanley', 'sebastianguerra@ymail.com', 'password123'),
  (2, 'Louisa Meyer', 'jacksonrose@hotmail.com', 'pass456'),
  (3, 'Dominic Parks', 'victoriablackwell@outlook.com', 'securepass');
